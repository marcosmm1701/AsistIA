    ...
    <section id="precios" className="section-padding px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center">
          ...
          >
            <div className="relative border border-[#c9a96e]/40 rounded-3xl p-8 md:p-10 bg-[#141210] overflow-hidden">
              {/* Glow */}
              ...
              <div className="mb-8">
                <div className="flex items-baseline gap-2 mb-1">
                  <span className="font-serif text-7xl font-semibold text-gradient-gold">249</span>
              ...
              <button
                onClick={onOpenModal}
                className="w-full bg-[#c9a96e] hover:bg-[#dbbe8a] text-[#0f0e0d] font-semibold py-4 rounded-2xl text-base transition-all duration-200 hover:shadow-xl hover:shadow-[#c9a96e]/25 hover:-translate-y-0.5"
              >
                Empezar gratis →
              </button>
